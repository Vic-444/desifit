import { $ as DEFAULT_404_COMPONENT, A as GetStaticPathsInvalidRouteParam, B as NoMatchingStaticPathFound, C as ActionNotFoundError, D as ClientAddressNotAvailable, E as CacheNotEnabled, F as LocalsNotAnObject, G as ResponseSentError, H as PrerenderClientAddressNotAvailable, I as LocalsReassigned, J as i18nNoLocaleFoundInPath, K as RewriteWithBodyUsed, L as MiddlewareNoDataOrNextCalled, N as InvalidGetStaticPathsEntry, O as ForbiddenRewrite, P as InvalidGetStaticPathsReturn, Q as ASTRO_GENERATOR, R as MiddlewareNotAResponse, T as AstroResponseHeadersReassigned, U as PrerenderDynamicEndpointPathCollide, V as PageNumberParamNotFound, W as ReservedSlotName, X as isAstroError, Y as AstroError, Z as ASTRO_ERROR_HEADER, _ as pushDirective, a as renderComponent, at as responseSentSymbol$1, ct as generateCspDigest, d as renderTemplate, et as REDIRECT_STATUS_CODES, g as normalizeCspResourceEntry, h as isRenderInstruction, i as renderJSX, it as originPathnameSymbol, j as GetStaticPathsRequired, k as GetStaticPathsExpectedParams, l as renderSlotToString, n as isRoute404, nt as clientAddressSymbol, o as chunkToString, ot as decodeKey, q as StaticClientAddressNotAvailable, r as isRoute500, rt as fetchStateSymbol, s as createSlotValueFromString, st as decryptString, t as renderPage, tt as REROUTABLE_STATUS_CODES, u as isRenderTemplateResult, v as isAstroComponentFactory, w as ActionsReturnedInvalidDataError, x as renderEndpoint, y as markHTMLString, z as NoManifestAvailable } from "./chunks/server_CK6TpkW3.mjs";
...
[
	{
		...
		"routeData": {
			...
			"params": ["category"],
			"component": "src/pages/categories/[category].astro",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
			"origin": "project",
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/categories.astro",
			"pathname": "/categories",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/contact.md",
			"pathname": "/contact",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
	...
	},
	{
		...
		"routeData": {
			...
			"params": [],
			"component": "src/pages/disclosure.md",
			"pathname": "/disclosure",
			"prerender": true,
			"fallbackRoutes": [],
			"distURL": [],
...
var _page0 = () => import("./chunks/_category__B3l0GpDK.mjs");
var _page1 = () => import("./chunks/categories_Ce_KHkSl.mjs");
var _page2 = () => import("./chunks/contact_CZoxNIZ6.mjs");
var _page3 = () => import("./chunks/disclosure_DIp0_R3Q.mjs");
var _page4 = () => import("./chunks/privacy_DzRmUB9G.mjs");
var _page5 = () => import("./chunks/index_Bcct-5Ft.mjs");
var pageMap = /* @__PURE__ */ new Map([
	["src/pages/categories/[category].astro", _page0],
	["src/pages/categories.astro", _page1],
	["src/pages/contact.md", _page2],
	["src/pages/disclosure.md", _page3],
	["src/pages/privacy.md", _page4],
	["src/pages/index.astro", _page5]
]);
//#endregion
//#region \0virtual:astro:manifest
var _manifest = deserializeManifest({"rootDir":"file:///workspaces/desifit/","cacheDir":"file:///workspaces/desifit/node_modules/.astro/","outDir":"file:///workspaces/desifit/dist/","srcDir":"file:///workspaces/desifit/src/","publicDir":"file:///workspaces/desifit/public/","buildClientDir":"file:///workspaces/desifit/dist/client/","buildServerDir":"file:///workspaces/desifit/dist/server/","adapterName":"","assetsDir":"_astro","routes":[{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{color:#222;background-color:#fff;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,sans-serif}\n"}],"routeData":{"route":"/categories/[category]","isIndex":false,"type":"page","pattern":"^\\/categories\\/([^/]+?)\\/?$","segments":[[{"content":"categories","dynamic":false,"spread":false}],[{"content":"category","dynamic":true,"spread":false}]],"params":["category"],"component":"src/pages/categories/[category].astro","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{color:#222;background-color:#fff;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,sans-serif}\n"}],"routeData":{"route":"/categories","isIndex":false,"type":"page","pattern":"^\\/categories\\/?$","segments":[[{"content":"categories","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/categories.astro","pathname":"/categories","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{color:#222;background-color:#fff;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,sans-serif}\n"}],"routeData":{"route":"/contact","isIndex":false,"type":"page","pattern":"^\\/contact\\/?$","segments":[[{"content":"contact","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/contact.md","pathname":"/contact","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{color:#222;background-color:#fff;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,sans-serif}\n"}],"routeData":{"route":"/disclosure","isIndex":false,"type":"page","pattern":"^\\/disclosure\\/?$","segments":[[{"content":"disclosure","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/disclosure.md","pathname":"/disclosure","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{color:#222;background-color:#fff;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,sans-serif}\n"}],"routeData":{"route":"/privacy","isIndex":false,"type":"page","pattern":"^\\/privacy\\/?$","segments":[[{"content":"privacy","dynamic":false,"spread":false}]],"params":[],"component":"src/pages/privacy.md","pathname":"/privacy","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}},{"file":"","links":[],"scripts":[],"styles":[{"type":"inline","content":"html,body{color:#222;background-color:#fff;margin:0;padding:0;font-family:system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,Oxygen,Ubuntu,Cantarell,sans-serif}\n"}],"routeData":{"route":"/","isIndex":true,"type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":true,"fallbackRoutes":[],"distURL":[],"origin":"project","_meta":{"trailingSlash":"ignore"}}}],"serverLike":false,"middlewareMode":"classic","base":"/","trailingSlash":"ignore","compressHTML":"jsx","componentMetadata":[["/workspaces/desifit/src/pages/categories.astro",{"propagation":"none","containsHead":true}],["/workspaces/desifit/src/pages/categories/[category].astro",{"propagation":"none","containsHead":true}],["/workspaces/desifit/src/pages/contact.md",{"propagation":"none","containsHead":true}],["/workspaces/desifit/src/pages/disclosure.md",{"propagation":"none","containsHead":true}],["/workspaces/desifit/src/pages/index.astro",{"propagation":"none","containsHead":true}],["/workspaces/desifit/src/pages/privacy.md",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var l=(n,t)=>{let i=async()=>{await(await n())()},e=typeof t.value==\"object\"?t.value:void 0,s={timeout:e==null?void 0:e.timeout};\"requestIdleCallback\"in window?window.requestIdleCallback(i,s):setTimeout(i,s.timeout||200)};(self.Astro||(self.Astro={})).idle=l;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var n=(a,t)=>{let i=async()=>{await(await a())()};if(t.value){let e=matchMedia(t.value);e.matches?i():e.addEventListener(\"change\",i,{once:!0})}};(self.Astro||(self.Astro={})).media=n;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var a=(s,i,o)=>{let r=async()=>{await(await s())()},t=typeof i.value==\"object\"?i.value:void 0,c={rootMargin:t==null?void 0:t.rootMargin},n=new IntersectionObserver(e=>{for(let l of e)if(l.isIntersecting){n.disconnect(),r();break}},c);for(let e of o.children)n.observe(e)};(self.Astro||(self.Astro={})).visible=a;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"astro/entrypoints/prerender":"prerender-entry.CdE4Afs9.mjs","\u0000virtual:astro:page:src/pages/categories/[category]@_@astro":"chunks/_category__B3l0GpDK.mjs","\u0000noop-middleware":"chunks/_noop-middleware_CQ50ikAJ.mjs","\u0000virtual:astro:server-island-manifest":"chunks/_virtual_astro_server-island-manifest_C1Q2srgE.mjs","\u0000virtual:astro:session-driver":"chunks/_virtual_astro_session-driver_C-PI1Pas.mjs","\u0000virtual:astro:page:src/pages/categories@_@astro":"chunks/categories_Ce_KHkSl.mjs","\u0000virtual:astro:page:src/pages/contact@_@md":"chunks/contact_CZoxNIZ6.mjs","\u0000virtual:astro:page:src/pages/disclosure@_@md":"chunks/disclosure_DIp0_R3Q.mjs","\u0000virtual:astro:page:src/pages/index@_@astro":"chunks/index_Bcct-5Ft.mjs","\u0000virtual:astro:actions/noop-entrypoint":"chunks/noop-entrypoint_Z3zFhrGC.mjs","\u0000virtual:astro:page:src/pages/privacy@_@md":"chunks/privacy_DzRmUB9G.mjs","virtual:astro:noop":"_astro/_virtual_astro_noop.SBldSjMi.js","astro:scripts/before-hydration.js":""},"inlinedScripts":[],"assets":["/file:///workspaces/desifit/dist/categories/index.html","/file:///workspaces/desifit/dist/contact/index.html","/file:///workspaces/desifit/dist/disclosure/index.html","/file:///workspaces/desifit/dist/privacy/index.html","/file:///workspaces/desifit/dist/index.html"],"buildFormat":"directory","checkOrigin":false,"actionBodySizeLimit":1048576,"serverIslandBodySizeLimit":1048576,"allowedDomains":[],"key":"FwgZNWtFjXX3h7jf/Fpz0J8/MUjaMQ+zNESNmWeAgQY=","image":{},"devToolbar":{"enabled":false,"debugInfoOutput":""},"logLevel":"info","shouldInjectCspMetaTags":false});
...
function deserializeActionResult(res) {
	if (res.type === "error") {
		...
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/codespace/nvm/current/bin/npm" })?.PROD) return {
...
function serializeActionResult(res) {
	if (res.error) {
		if (Object.assign({
			...
			"SITE": void 0,
			"SSR": true
		}, { _: "/home/codespace/nvm/current/bin/npm" })?.DEV) actionResultErrorStack.set(res.error.stack);
		let body2;
